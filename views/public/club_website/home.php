                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-8">
                            <?php if (!empty($org['logo_url'])): ?>
                                <img src="<?= htmlspecialchars($org['logo_url']) ?>" alt="Crest" height="80" class="mb-4 bg-white p-2 rounded-3 shadow">
                            <?php endif; ?>
                            <h1 class="display-3 fw-black text-uppercase text-white mb-3 lh-1">
                                <?= htmlspecialchars($settings['hero_title'] ?: $org['name']) ?>
                            </h1>
                            <p class="lead text-white-50 mb-4 fs-4 max-w-2xl">
