...
$pricingCards = [
    ...
    [
        ...
        'interval' => '/ year',
        'savings_kes' => 'Save KSh 2,000 / year • 16.67% off',
        'savings_usd' => 'Save $' . number_format(($intlStdM['charged_amount'] * 12) - $intlStdY['charged_amount'], 0) . ' / year • 16.67% off',
    ...
    [
        ...
        'price_kes' => 'KSh 25,000',
        'price_usd' => '$' . number_format($intlProY['charged_amount'], 2),
        'interval' => '/ year',
        'savings_kes' => 'Save KSh 5,000 / year • 16.67% off',
        'savings_usd' => 'Save $' . number_format(($intlProM['charged_amount'] * 12) - $intlProY['charged_amount'], 0) . ' / year • 16.67% off',
