    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <form method="POST" action="<?= url("/o/") ?><?= htmlspecialchars($tenant['slug']) ?>/s/<?= htmlspecialchars($sport['slug']) ?>/players" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Only collect if required by league rules.</div>
                        </div>
